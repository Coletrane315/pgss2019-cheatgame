...
from model import PredictOutput
...
class BluffCalculator:
        ...
        def should_bluff_0_card(self, card_turn, game_state):
                ...
                while cardsOfLastSeq > 1:    
                        ...
                        if PredictOutput.predict([[num, centerCards, cardsSwitched, probLieWithThreeCopies]]) == 1:
                                return self.pick_card_to_lie_with(game_state, 3) #kicks it to figure out what we should lie with
                        
                        elif PredictOutput.predict([[num, centerCards, cardsSwitched, probLieWithTwoCopies]]) == 1:
                                return self.pick_card_to_lie_with(game_state, 2)
                        
                        elif PredictOutput.predict([[num, centerCards, cardsSwitched, probLieWithOneCopy]]) == 1:
        ...
        def should_bluff_2_card(self, card_turn, game_state):
                ...
                if PredictOutput.predict([[num, centerCards, cardsSwitched, prob]]) == 1:
